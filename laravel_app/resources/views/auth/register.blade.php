                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" required>
                                    <option value="lid">{{ __('Lid') }}</option>
                                    <option value="schacht">{{ __('Schacht') }}</option>
                                    <option value="commilitoon">{{ __('Commilitoon') }}</option>
                                    <option value="praesidium">{{ __('Praesidium') }}</option>
                                    <option value="ouwe zak">{{ __('Ouwe Zak') }}</option>
                                </select>
